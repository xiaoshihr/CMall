...
namespace Senparc.Weixin.MP.TenPayLibV3
{
    ...
    public class RedPackApi
    {
        ...
        /// <returns></returns>
        public static NormalRedPackResult SendNormalRedPack(string billno, string appId, string mchId, string tenPayKey, string tenPayCertPath,
