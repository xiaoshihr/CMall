...
namespace qiaojiaren.Manger
{
    public partial class wei_MenusList : basePage
    {
        ...
        BrnMall.Core.Model.YX_weiXinMenus mol = new BrnMall.Core.Model.YX_weiXinMenus();
        ...
        protected void BindInfo(string where)
        {
            ...
            dt = BrnMall.Core.DBUtility.ProcUtility.GetPageProBll("YX_weiXinMenus", "*", " Id desc", where, pageSize, pageIndex, out totalPage, out recordCount);
        ...
        {
            BrnMall.Core.WeiXinHelp wx = new BrnMall.Core.WeiXinHelp();
            wx.CreateMenu();
        }
    }
}
