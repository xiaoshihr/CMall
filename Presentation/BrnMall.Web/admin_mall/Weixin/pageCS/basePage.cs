...
namespace qiaojiaren.Manger
{
    ...
    {
        //BrnMall.Core.BLL.YX_Menus Mbll = new BrnMall.Core.BLL.YX_Menus();//导航栏对象
        ...
        {
            object CSS = BrnMall.Core.Common.CacheHelper.GetCache("CSS");//设置CSS缓存，防止多次创建StringBuilder对象
            if (CSS != null)
            {
                return CSS.ToString();
            }
            else
            {
                ...
                BrnMall.Core.Common.CacheHelper.SetCache("CSS", sb.ToString(), TimeSpan.FromMinutes(60));
                return sb.ToString();
            }
        ...
        public string GetJS()
        {
            object JS = BrnMall.Core.Common.CacheHelper.GetCache("JS");//设置JS缓存，防止多次创建StringBuilder对象
            if (JS != null)
            {
                return JS.ToString();
            }
        ...
        <script src='js/jquery-1.7.2.js'></script>
            <script type='text/javascript'>
                ...
                BrnMall.Core.Common.CacheHelper.SetCache("JS", sb.ToString(), TimeSpan.FromMinutes(60));
                return sb.ToString();
            }
        }
        #endregion
