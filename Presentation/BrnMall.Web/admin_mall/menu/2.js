var menuList = [{
    "title": "商品管理", "subMenuList": [{ "title": "添加商品", "url": "/malladmin/product/addproduct" },
...
{
    "title": "促销活动", "subMenuList": [{ "title": "单品促销", "url": "/malladmin/promotion/singlepromotionlist" },
...
{
    "title": "订单管理", "subMenuList": [{ "title": "订单列表", "url": "/malladmin/order/orderlist" },
      { "title": "退款列表", "url": "/malladmin/order/refundlist" }]
},
{
    "title": "咨询评价", "subMenuList": [{ "title": "商品评价", "url": "/malladmin/productreview/productreviewlist" },
      { "title": "商品咨询", "url": "/malladmin/productconsult/productconsultlist" },
      { "title": "咨询类型", "url": "/malladmin/productconsult/productconsulttypelist" }]
},
{
    "title": "用户管理", "subMenuList": [{ "title": "用户列表", "url": "/malladmin/user/list" },
      { "title": "会员等级", "url": "/malladmin/userrank/list" },
      { "title": "管理员组", "url": "/malladmin/malladmingroup/list" }]
},
{
    "title": "微信", "subMenuList": [{ "title": "红包列表", "url": "/malladmin/weixin/SendBagList" },
    { "title": "微信支付订单", "url": "/malladmin/weixin/PayOrderList" }]
},
{
    "title": "店铺管理", "subMenuList": [{ "title": "店铺列表", "url": "/malladmin/store/storelist" },
      { "title": "店铺行业", "url": "/malladmin/storeindustry/list" },
      { "title": "店铺等级", "url": "/malladmin/storerank/list" }]
},
{
    "title": "新闻管理", "subMenuList": [{ "title": "新闻类型", "url": "/malladmin/news/newstypelist" },
      { "title": "新闻列表", "url": "/malladmin/news/newslist" }]
},
{
    "title": "广告管理", "subMenuList": [{ "title": "广告位置", "url": "/malladmin/advert/advertpositionlist" },
      { "title": "广告列表", "url": "/malladmin/advert/advertlist" }]
}, {
    "title": "商城内容", "subMenuList": [{ "title": "导航菜单", "url": "/malladmin/nav/list" },
        { "title": "商城帮助", "url": "/malladmin/help/list" },
        { "title": "友情链接", "url": "/malladmin/friendlink/list" }]
},
{
    "title": "商品性质", "subMenuList": [{ "title": "商品品牌", "url": "/malladmin/brand/list" },
        { "title": "分类管理", "url": "/malladmin/category/categorylist" }]
},
{
    "title": "报表统计", "subMenuList": [{ "title": "在线用户", "url": "/malladmin/stat/onlineuserlist" },
        { "title": "搜索分析", "url": "/malladmin/stat/searchwordstatlist" },
        { "title": "商品统计", "url": "/malladmin/stat/productstat" },
        { "title": "销售明细", "url": "/malladmin/stat/saleproductlist" },
        { "title": "订单统计", "url": "/malladmin/stat/orderstat" },
        { "title": "地区统计", "url": "/malladmin/stat/regionstat" },
        { "title": "客户端统计", "url": "/malladmin/stat/clientstat" }]
},
{
    "title": "系统设置", "subMenuList": [{ "title": "站点信息", "url": "/malladmin/set/site" },
...
{
    "title": "商城插件", "subMenuList": [{ "title": "授权插件", "url": "/malladmin/plugin/list?type=0" },
      { "title": "支付插件", "url": "/malladmin/plugin/list?type=1" }]
},
{
    "title": "日志管理", "subMenuList": [{ "title": "商城日志", "url": "/malladmin/log/malladminloglist" },
        { "title": "店铺日志", "url": "/malladmin/log/storeadminloglist" },
        { "title": "积分日志", "url": "/malladmin/log/creditloglist" }]
},
{
    "title": "开发人员", "subMenuList": [{ "title": "事件管理", "url": "/malladmin/event/list" },
