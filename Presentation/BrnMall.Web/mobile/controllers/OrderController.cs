...
namespace BrnMall.Web.Mobile.Controllers
{
    ...
    public partial class OrderController : BaseMobileController
    {
        ...
        public ActionResult ConfirmOrder()
        {
            ...
            decimal disc = 1.00m;
            model.Discount = 0;
            model.DiscountLv = 100;
            if (WorkContext.UserLevel == 1)
            {
                
                model.DiscountLv = 95;
                disc = model.DiscountLv / 100;
                model.Discount = model.AllProductAmount - (model.AllProductAmount * disc);
                model.AllProductAmount = model.AllProductAmount - model.Discount;
            }
        ...
        public ActionResult SubmitOrder()
        {
            lock (_locker)
            {
                ...
                //return AjaxResult("success", "/mob/weixinweb/OrderPay?oidList=" + oidList.TrimEnd(','));
                //return AjaxResult("success", Url.Action("OrderPay", "weixinweb", new RouteValueDictionary { { "oidList", oidList.TrimEnd(',') } }));
            }
        }
        ...
        public ActionResult SubmitResult()
        {
            ...
            return Redirect("/mob/weixinweb/OrderPay?oidList=" + oidList);
