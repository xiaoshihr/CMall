...
namespace BrnMall.Web.Framework
{
    ...
    public class MobileWorkContext
    {
        ...
        public int Pid = 0;//父级ID

        public int Userno = 0; //用户编号

        public int UserLevel = 0;//用户等级

        public int IsReal = 0;//用户等级

        public int NoCollarBag = 0; //未领红包

        public int HaCollarBag = 0; //已领红包

        public int CollarBag = 0;//全部
