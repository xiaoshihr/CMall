...
namespace qiaojiaren.Manger
{
    public partial class wei_EventEdit : System.Web.UI.Page
    {
        ...
        public BrnShop.Core.Model.YX_weiXinMenus mol = new BrnShop.Core.Model.YX_weiXinMenus();
        ...
        public DataTable dt_News = new DataTable(); BrnShop.Core.DBUtility.T_SQL imp = new BrnShop.Core.DBUtility.T_SQL();
