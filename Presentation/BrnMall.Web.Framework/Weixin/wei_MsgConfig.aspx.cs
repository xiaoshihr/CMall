...
namespace qiaojiaren.Manger
{
    public partial class wei_MsgConfig : basePage
    {
        ...
        BrnShop.Core.Model.YX_Event mol = new BrnShop.Core.Model.YX_Event();
        BrnShop.Core.BLL.YX_Event bll = new BrnShop.Core.BLL.YX_Event();
        ...
        protected void BindInfo(string where)
        {
            ...
            dt = BrnShop.Core.DBUtility.ProcUtility.GetPageProBll("YX_Event", "*", " Id desc", where, pageSize, pageIndex, out totalPage, out recordCount);
