...
namespace BrnMall.ConfigStrategy.File
{
    ...
    public partial class ConfigStrategy : IConfigStrategy
    {
        ...
        private readonly string _weixinconfigfilepath = "/App_Data/weixin.config";//微信
        #endregion
        ...
        {
            return (WeiXinConfig)LoadConfigInfo(typeof(WeiXinConfig), IOHelper.GetMapPath(_weixinconfigfilepath));
        }
    }
}
