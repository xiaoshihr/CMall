...
namespace BrnMall.Core.DAL
{
	...
	public partial class YX_voice
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "YX_voice"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from YX_voice");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(BrnMall.Core.Model.YX_voice model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into YX_voice(");
			strSql.Append("EventId,voiceMediaId,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2)");
			strSql.Append(" values (");
			strSql.Append("@EventId,@voiceMediaId,@EventCate,@remark1,@remark2,@remark3,@flat1,@flat2,@remark4,@remark5,@remark6,@flat7,@flat8,@RegTim1,@RegTim2)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@EventId", SqlDbType.Int,4),
					new SqlParameter("@voiceMediaId", SqlDbType.VarChar,500),
			...
			parameters[1].Value = model.voiceMediaId;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(BrnMall.Core.Model.YX_voice model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update YX_voice set ");
			strSql.Append("EventId=@EventId,");
			strSql.Append("voiceMediaId=@voiceMediaId,");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from YX_voice ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public BrnMall.Core.Model.YX_voice GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,EventId,voiceMediaId,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2 from YX_voice ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			BrnMall.Core.Model.YX_voice model=new BrnMall.Core.Model.YX_voice();
		...
		/// 得到一个对象实体
		/// </summary>
		public BrnMall.Core.Model.YX_voice DataRowToModel(DataRow row)
		{
			BrnMall.Core.Model.YX_voice model=new BrnMall.Core.Model.YX_voice();
			if (row != null)
			{
				...
				if(row["voiceMediaId"]!=null)
				{
					model.voiceMediaId=row["voiceMediaId"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,EventId,voiceMediaId,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2 ");
			strSql.Append(" FROM YX_voice ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,EventId,voiceMediaId,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2 ");
			strSql.Append(" FROM YX_voice ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from YX_voice T ");
