...
namespace BrnMall.Core.DAL
{
	...
	public partial class YX_news
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "YX_news"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from YX_news");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(BrnMall.Core.Model.YX_news model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into YX_news(");
			strSql.Append("EventId,newsTitle,newsDescription,newsPicUrl,newsUrl,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@newsDescription", SqlDbType.NVarChar,1000),
					new SqlParameter("@newsPicUrl", SqlDbType.VarChar,1000),
					new SqlParameter("@newsUrl", SqlDbType.VarChar,1000),
			...
			parameters[2].Value = model.newsDescription;
			parameters[3].Value = model.newsPicUrl;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(BrnMall.Core.Model.YX_news model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update YX_news set ");
			strSql.Append("EventId=@EventId,");
			strSql.Append("newsTitle=@newsTitle,");
			strSql.Append("newsDescription=@newsDescription,");
			strSql.Append("newsPicUrl=@newsPicUrl,");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from YX_news ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public BrnMall.Core.Model.YX_news GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,EventId,newsTitle,newsDescription,newsPicUrl,newsUrl,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2 from YX_news ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			BrnMall.Core.Model.YX_news model=new BrnMall.Core.Model.YX_news();
		...
		/// 得到一个对象实体
		/// </summary>
		public BrnMall.Core.Model.YX_news DataRowToModel(DataRow row)
		{
			BrnMall.Core.Model.YX_news model=new BrnMall.Core.Model.YX_news();
			if (row != null)
			{
				...
				if(row["newsDescription"]!=null)
				{
					model.newsDescription=row["newsDescription"].ToString();
				}
				if(row["newsPicUrl"]!=null)
				{
					model.newsPicUrl=row["newsPicUrl"].ToString();
				}
				if(row["newsUrl"]!=null)
				{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,EventId,newsTitle,newsDescription,newsPicUrl,newsUrl,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2 ");
			strSql.Append(" FROM YX_news ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,EventId,newsTitle,newsDescription,newsPicUrl,newsUrl,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2 ");
			strSql.Append(" FROM YX_news ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from YX_news T ");
