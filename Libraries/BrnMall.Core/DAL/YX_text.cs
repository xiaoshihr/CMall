...
namespace BrnMall.Core.DAL
{
	...
	public partial class YX_text
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "YX_text"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from YX_text");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(BrnMall.Core.Model.YX_text model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into YX_text(");
			strSql.Append("EventId,msgContent,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2)");
			strSql.Append(" values (");
			strSql.Append("@EventId,@msgContent,@EventCate,@remark1,@remark2,@remark3,@flat1,@flat2,@remark4,@remark5,@remark6,@flat7,@flat8,@RegTim1,@RegTim2)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@EventId", SqlDbType.Int,4),
					new SqlParameter("@msgContent", SqlDbType.NVarChar,1000),
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(BrnMall.Core.Model.YX_text model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update YX_text set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from YX_text ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public BrnMall.Core.Model.YX_text GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,EventId,msgContent,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2 from YX_text ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			BrnMall.Core.Model.YX_text model=new BrnMall.Core.Model.YX_text();
		...
		/// 得到一个对象实体
		/// </summary>
		public BrnMall.Core.Model.YX_text DataRowToModel(DataRow row)
		{
			BrnMall.Core.Model.YX_text model=new BrnMall.Core.Model.YX_text();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,EventId,msgContent,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2 ");
			strSql.Append(" FROM YX_text ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,EventId,msgContent,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2 ");
			strSql.Append(" FROM YX_text ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from YX_text T ");
