...
namespace BrnMall.Core.DAL
{
	...
	public partial class YX_music
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "YX_music"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from YX_music");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(BrnMall.Core.Model.YX_music model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into YX_music(");
			strSql.Append("EventId,musicTitle,musicDescription,musicMediaId,musicUrl,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2)");
			strSql.Append(" values (");
			strSql.Append("@EventId,@musicTitle,@musicDescription,@musicMediaId,@musicUrl,@EventCate,@remark1,@remark2,@remark3,@flat1,@flat2,@remark4,@remark5,@remark6,@flat7,@flat8,@RegTim1,@RegTim2)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@EventId", SqlDbType.Int,4),
					new SqlParameter("@musicTitle", SqlDbType.NVarChar,50),
					new SqlParameter("@musicDescription", SqlDbType.NVarChar,1000),
					new SqlParameter("@musicMediaId", SqlDbType.VarChar,500),
					new SqlParameter("@musicUrl", SqlDbType.VarChar,500),
			...
			parameters[1].Value = model.musicTitle;
			parameters[2].Value = model.musicDescription;
			parameters[3].Value = model.musicMediaId;
			parameters[4].Value = model.musicUrl;
			parameters[5].Value = model.EventCate;
			parameters[6].Value = model.remark1;
			parameters[7].Value = model.remark2;
			parameters[8].Value = model.remark3;
			parameters[9].Value = model.flat1;
			parameters[10].Value = model.flat2;
			parameters[11].Value = model.remark4;
			parameters[12].Value = model.remark5;
			parameters[13].Value = model.remark6;
			parameters[14].Value = model.flat7;
			parameters[15].Value = model.flat8;
			parameters[16].Value = model.RegTim1;
			parameters[17].Value = model.RegTim2;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(BrnMall.Core.Model.YX_music model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update YX_music set ");
			strSql.Append("EventId=@EventId,");
			strSql.Append("musicTitle=@musicTitle,");
			strSql.Append("musicDescription=@musicDescription,");
			strSql.Append("musicMediaId=@musicMediaId,");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from YX_music ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public BrnMall.Core.Model.YX_music GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,EventId,musicTitle,musicDescription,musicMediaId,musicUrl,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2 from YX_music ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			BrnMall.Core.Model.YX_music model=new BrnMall.Core.Model.YX_music();
		...
		/// 得到一个对象实体
		/// </summary>
		public BrnMall.Core.Model.YX_music DataRowToModel(DataRow row)
		{
			BrnMall.Core.Model.YX_music model=new BrnMall.Core.Model.YX_music();
			if (row != null)
			{
				...
				if(row["musicTitle"]!=null)
				{
					model.musicTitle=row["musicTitle"].ToString();
				}
				if(row["musicDescription"]!=null)
				{
					model.musicDescription=row["musicDescription"].ToString();
				}
				if(row["musicMediaId"]!=null)
				{
					model.musicMediaId=row["musicMediaId"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,EventId,musicTitle,musicDescription,musicMediaId,musicUrl,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2 ");
			strSql.Append(" FROM YX_music ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,EventId,musicTitle,musicDescription,musicMediaId,musicUrl,EventCate,remark1,remark2,remark3,flat1,flat2,remark4,remark5,remark6,flat7,flat8,RegTim1,RegTim2 ");
			strSql.Append(" FROM YX_music ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from YX_music T ");
