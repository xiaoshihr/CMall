...
namespace BrnMall.Core
{
    ...
    public partial class BMAConfig
    {
        ...
        private static WeiXinConfig _weixinconfig = null;
        static BMAConfig()
        {
            try
            {
        ...
        /// 微信参数配置
        /// </summary>
        public static WeiXinConfig WeiXinConfig
        {
            get
            {
                if (_weixinconfig == null)
                {
                    lock (_locker)
                    {
                        if (_weixinconfig == null)
                        {
                            _weixinconfig = _iconfigstrategy.GetWeiXinConfig();
                        }
                    }
                }

                return _weixinconfig;
            }
        }
        /// <summary>
        /// 商城基本配置信息
