...
namespace BrnMall.Data
{
    ...
    public partial class Users
    {
        ...
        public static PartUserInfo BuildPartUserFromReader(IDataReader reader)
        {
            ...
            partUserInfo.Openid = reader["Openid"].ToString();
            partUserInfo.Pid = TypeHelper.ObjectToInt(reader["Pid"]);
            partUserInfo.UserLevel = TypeHelper.ObjectToInt(reader["UserLevel"]);
            partUserInfo.Userno = TypeHelper.ObjectToInt(reader["Userno"]);
            partUserInfo.Addtime = TypeHelper.ObjectToDateTime(reader["Addtime"]);
            partUserInfo.Layernum = TypeHelper.ObjectToInt(reader["Layernum"]);
            partUserInfo.IsReal = TypeHelper.ObjectToInt(reader["IsReal"]);
            return partUserInfo;
        }
        ...
        public static UserInfo BuildUserFromReader(IDataReader reader)
        {
            ...
            userInfo.Openid = reader["Openid"].ToString();
            userInfo.Pid = TypeHelper.ObjectToInt(reader["Pid"]);
            userInfo.UserLevel = TypeHelper.ObjectToInt(reader["UserLevel"]);
            userInfo.Userno = TypeHelper.ObjectToInt(reader["Userno"]);
            userInfo.Addtime = TypeHelper.ObjectToDateTime(reader["Addtime"]);
            userInfo.Layernum = TypeHelper.ObjectToInt(reader["Layernum"]);
            userInfo.IsReal = TypeHelper.ObjectToInt(reader["IsReal"]);
        ...
        /// <returns></returns>
        public static PartUserInfo GetPartUserByOpenid(string Openid)
        {
            PartUserInfo partUserInfo = null;

            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetPartUserByOpenid(Openid);
            if (reader.Read())
            {
                partUserInfo = BuildPartUserFromReader(reader);
            }
